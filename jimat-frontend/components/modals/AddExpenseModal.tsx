 ...
 * Allows users to create a new expense with AI features
 */
    ...
    <Dialog open={isOpen} onOpenChange={onClose}>
      <DialogContent className="sm:max-w-[500px]">
        <DialogHeader>
          ...
          <DialogDescription>Create a new expense record or scan a receipt</DialogDescription>
        </DialogHeader>
        ...
        <Tabs defaultValue="manual" className="w-full">
          ...
          <TabsContent value="receipt">
            <div className="space-y-4">
              ...
              {/* AI Category Suggestion for receipt mode */}
              {formData.description.trim() && (
                <AICategorySuggestion
                  description={formData.description}
                  amount={formData.amount ? parseFloat(String(formData.amount)) : undefined}
